...
import { FaCalendarAlt, FaChartBar, FaFileExport } from "react-icons/fa";
import { HiChevronLeft, HiChevronRight } from "react-icons/hi2";
import ExportSales from "../../components/popups/ExportSales"; // Import the ExportSales component
import AddExpense from "../../components/popups/AddExpense"; // Import the AddExpense component
...
const SalesCalendar = () => {
  ...
  const [showExportSales, setShowExportSales] = useState(false); // State to control the popup
  const [showAddExpense, setShowAddExpense] = useState(false); // State to control the AddExpense popup
  ...
  const handleExportClick = () => {
    setShowExportSales(true); // Open the ExportSales popup
  };

  const handleAddExpenseClick = () => {
    setShowAddExpense(true); // Open the AddExpense popup
  };
  ...
  return (
    <div className="h-screen bg-[#fcf4dc] flex flex-col p-6">
      ...
      {/* Export Sales Popup */}
      {showExportSales && (
        <ExportSales closePopup={() => setShowExportSales(false)} />
      )}
